        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
          <div className="relative w-full sm:w-64">
            <input
              ...
              className="w-[190px] focus:w-[290px] pl-10 pr-4 py-2 border border-gray-400 rounded focus:outline-none focus:ring-2 focus:ring-blue-300 transition-all duration-200 placeholder:text-gray-400"
            />
            ...
            <table className="w-full border-collapse bg-white rounded-lg shadow">
              <thead>
                <tr className="bg-gray-100">
                  <th className="p-3 text-left text-xs sm:text-sm font-semibold text-gray-700">{t('id')}</th>
                  <th className="p-3 text-left text-xs sm:text-sm font-semibold text-gray-700">{t('name')}</th>
                  <th className="p-3 text-center text-xs sm:text-sm font-semibold text-gray-700">{t('actions')}</th>
                </tr>
              </thead>
              <tbody>
                {users.map((user) => (
                  <tr key={user.id} className="border-b hover:bg-gray-50">
                    ...
                    <td className="p-3">
                      <div className="flex justify-center items-center gap-2 flex-wrap">
                        ...
                        >
                          <Edit size={14} />
                          <span className="hidden sm:inline font-medium">{t('edit')}</span>
                        </button>
                        <button
                        ...
                        >
                          <Trash2 size={14} />
                          <span className="hidden sm:inline font-medium">{t('delete')}</span>
                        </button>
                      </div>
                    </td>
                  </tr>
            ...
            <div className="flex gap-1 flex-wrap justify-center">
              ...
              {[...Array(totalPages)].map((_, index) => (
                <button
                  ...
                  className={`px-3 py-1 border rounded-lg ${page === index + 1 ? "bg-blue-600 text-white" : ""
                    }`}
                >
                  {index + 1}
                </button>
