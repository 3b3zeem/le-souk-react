...
const CategoriesSkeleton = ({ length }) => {
  ...
  return (
    <div className="max-w-7xl mx-auto py-30 px-4 sm:px-6 lg:px-8 border-b border-gray-300">
      <div className="flex flex-wrap justify-between mt-8 mb-6">
        <div className="h-6 skeleton-bg animate-pulse rounded w-40" />
        <div className="h-8 skeleton-bg animate-pulse rounded w-24" />
      </div>
        ...
        {skeletonCards.map((_, index) => (
          ...
          >
            <div className="relative flex justify-center items-center h-48 bg-gray-50">
              <div className="w-full h-full skeleton-bg animate-pulse" />
            </div>

            <div className="flex flex-col flex-1 p-4 gap-3">
              <div className="h-5 skeleton-bg animate-pulse rounded w-2/3 mx-auto" />
            </div>
          </div>
        ))}
      </div>
